...
package cn.keepli.freemarker.ui;


import cn.keepli.freemarker.core.GeneratorFacade;
...
public class CodeUi extends JFrame {
	...
	/** Creates new form CodeUi */
	public CodeUi(DataBase db, String dbName) {
		this.db = db;
		this.dbName = dbName;
		initComponents();
	}
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				DataBase db = new DataBase("mysql","freemarker");
				db.setUserName("root");
				db.setPassWord("root");
				new CodeUi (db,null).setVisible(true);
			}
		});
	}
